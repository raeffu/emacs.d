...
(custom-set-faces
 ...
 '(font-lock-variable-name-face ((((class color) (min-colors 89)) (:foreground "#ffb86c"))))
 '(helm-ff-dotted-directory ((t (:inherit helm-ff-directory))))
 '(magit-diffstat-added ((t (:foreground "#5af78e"))))
 '(magit-diffstat-removed ((t (:foreground "#ff6e67"))))
 '(magit-log-author ((t (:foreground "#f4f99d"))))
 ...
 '(mode-line ((t (:background "#565761" :box (:line-width 1 :color "#464752")))))
 '(mode-line-inactive ((t (:background "#464752" :foreground "#f8f8f2" :box (:line-width 1 :color "#282a36"))))))

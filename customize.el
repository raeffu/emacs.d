(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (alchemist solarized-theme cmake-mode ess matlab-mode nyan-mode zoom-window ace-jump-mode yaml-mode whitespace-cleanup-mode web-mode use-package typescript-mode smartparens scss-mode sass-mode rubocop rspec-mode rbenv rainbow-mode rainbow-delimiters persp-projectile page-break-lines overseer markdown-mode magit macrostep karma js2-refactor ibuffer-projectile highlight-numbers helm-swoop helm-projectile helm-flycheck helm-descbinds helm-ag exec-path-from-shell erlang enh-ruby-mode emmet-mode elisp-slime-nav drag-stuff default-text-scale company coffee-mode cask-mode ag)))
 ...
 '(zoom-window-mode-line-color "LightSalmon1"))
(custom-set-faces
 ...
 '(magit-diff-added ((t (:foreground "#01B100"))))
 '(magit-diff-added-highlight ((t (:inherit magit-diff-added :background "#eee8d5"))))
 '(magit-diff-base ((t (:background "green4" :foreground "#ffffcc"))))
 '(magit-diff-base-highlight ((t (:background "green3" :foreground "#eeeebb"))))
 '(magit-diff-removed ((t (:foreground "OrangeRed2"))))
 '(magit-diff-removed-highlight ((t (:inherit magit-diff-removed :background "#eee8d5"))))
 ...
 '(mode-line ((t (:background "#D0FED6" :foreground "#657b83" :box (:line-width 1 :color "#eee8d5" :style unspecified) :overline "#eee8d5" :underline "#cccec4"))))
 '(region ((t (:background "#F4706F" :foreground "#fdf6e3"))))
 '(smerge-base ((t (:background "#9DC89D"))))
 '(smerge-markers ((t (:background "#da635d" :foreground "white"))))
 '(smerge-mine ((t (:background "#FFE0DE"))))
 '(smerge-other ((t (:background "#E0EEE0"))))
 '(smerge-refined-added ((t (:inherit smerge-refined-change :background "#B2E7B0"))))
 '(smerge-refined-removed ((t (:inherit smerge-refined-change :background "#F3AAA6")))))
